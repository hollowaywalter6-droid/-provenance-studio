...
check('Canvas Lens limits large pages to nearby cards',overlay.includes('showing '+"'+shown.length+'"+' nearest')||overlay.includes('showing '+"'+shown.length+'"));
...
check('iPhone bookmarklet deduplicates and follows nearby questions',index.includes('function unique()')&&index.includes('__provenanceLensTimer')&&index.includes('showing '+"'+shown.length+'"+' nearest'));
