...
check('Release version synchronized',version.version==='4.5.0'&&index.includes("APP_VERSION='4.5.0'")&&sw.includes('provenance-v4-5-0')&&manifest.version==='2.5.0');
...
check('Practice automation has independent toggles',overlay.includes('autoSelect:')&&overlay.includes('autoFill:')&&overlay.includes('autoSubmit:')&&index.includes('Auto-select, Auto-fill, and Auto-submit practice toggles'));
